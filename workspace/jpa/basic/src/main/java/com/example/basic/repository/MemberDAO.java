...
//    1. application.yml 파일에 작성된 Connection 정보를 통해 EntityManageFactory가 생성된다.
//    2. EntityManageFactory를 통해 EntityManager 객체가 생성된다.

    @PersistenceContext // EntityManager를 통해서 생성된 Entity 객체가 등록되는 영역
